...
![](/assets/Multi-Tenant/scheduling%20model.png){: width="750" }
...
![](/assets/Multi-Tenant/fifo.png){: width="750" }
...
![](/assets/Multi-Tenant/user%20round%20robin%20queue.png){: width="750" }

可以看到出队顺序确实更加公平了，但是如果每个请求的开销并不那么一致呢？

![](/assets/Multi-Tenant/user%20round%20robin%20queue%202.png){: width="750" }
...
![](/assets/Multi-Tenant/gps.png){: width="750" }
...
![](/assets/Multi-Tenant/fq.png){: width="750" }
...
![](/assets/Multi-Tenant/wfq.png){: width="750" }
...
![](/assets/Multi-Tenant/wfq1.png){: width="750" }![](/assets/Multi-Tenant/wfq2.png){: width="750" }

WF²Q为了解决这个问题，添加出队约束：
- 只有当$S_f^j \le V_{now}$时，才允许这个任务被调度。

![](/assets/Multi-Tenant/wfq3.png){: width="750" }
...
![](/assets/Multi-Tenant/wfq4.png){: width="750" }
...
![](/assets/Multi-Tenant/wfq5.png){: width="750" }
...
![](/assets/Multi-Tenant/l1.png){: width="750" }![](/assets/Multi-Tenant/l2.png){: width="750" }
...
![](/assets/Multi-Tenant/2dfq1.png){: width="750" }
